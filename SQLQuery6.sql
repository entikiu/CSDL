...
INSERT INTO PHONG(MA_PHONG, VI_TRI, DIEN_TICH)
	VALUES ('PH101', 'MAT_TIEN', '100.2')
CREATE TABLE PHG_DV (
    MA_PHONG VARCHAR(10),
    MA_DV VARCHAR(10),
...
INSERT INTO MON_TB(MA_MON, MA_TB, NGAY_MUA, TRI_GIA_MUA)
	VALUES ( 'MM0001',
			'ML01',
			'20250206',
			'2000000.00'
...
INSERT INTO PH_PHOI_TB
	VALUES ('PH101',
			'MM0001',
			CAST ('06-02-2026' AS DATE),
			NULL,
			NULL,
			NULL
			)

SELECT *FROM PH_PHOI_TB
